            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form name="action" action="server/controllers/controller.php" method="POST" class=" space-y-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" placeholder="name..." name="name" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" pattern="[0-9]{5}" placeholder="postcode..." name="postcode" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
